  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-zinc-50 font-sans dark:bg-black">
      <main className="min-h-screen w-full justify-between py-32 px-16 bg-white  sm:items-start">
          <div className={"text-black text-7xl w-full"}><span className={"text-[#006948]"}>Uh...</span></div>
            <div className={"text-black text-3xl w-full"}>You were not supposed to be he⍑𝙹!¡ᒷ  𝙹リᒷ</div>
